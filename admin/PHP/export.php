...
<head>
	...
	<title>Medical Bloc - Exporter un fichier</title>
...
<body>
	<header>
		...
		<nav>
			...
			<a href="export.php"  id="active">Exporter un ficher</a>
	...
	<main>
		<section class="home">
			<a href="../index.html">acceuil></a><a href="export.php">exporter un fichier</a>
		</section>
		...
		<section class="home1">
			<h3>Liste des patients du jour.</h3>
		</section>
				...
				<?php if (!empty($patients)): ?>
					<?php foreach ($patients as $patient): ?>
						<div class="patient">
							...
							<form action="../process/generer_pdf.php" method="POST" target="_blank">
								<input type="hidden" name="patient_id" value="<?= $patient['id'] ?>">
								<button type="submit">Exporter le fichier PDF</button>
							</form>
						</div>
					<?php endforeach; ?>
				<?php else: ?>
